...
const struct tinwhistle_explicit_entry tinwhistle_explicit[64] PROGMEM = {
...
const struct uilleann_explicit_entry uilleann_explicit[128] PROGMEM = {
...
const struct GHB_explicit_entry GHB_explicit[128] PROGMEM = {
...
const struct northumbrian_general_entry northumbrian_general[8] PROGMEM = {
...
const struct gaita_extended_explicit_entry gaita_extended_explicit[256] PROGMEM = {
  //general fingering pattern for each MIDI note. In this case, the index (position from right) of the leftmost uncovered hole is used to determine the MIDI note. This way all other holes below that one are ignored.
...
const struct gaita_explicit_entry gaita_explicit[256] PROGMEM = {
  //general fingering pattern for each MIDI note. In this case, the index (position from right) of the leftmost uncovered hole is used to determine the MIDI note. This way all other holes below that one are ignored.
  { 75 },  //00000000 C
  { 75 },  //00000001
  { 75 },  //00000010 C
...
const struct naf_explicit_entry naf_explicit[128] PROGMEM = {
  //general fingering pattern for each MIDI note. In this case, the index (position from right) of the leftmost uncovered hole is used to determine the MIDI note. This way all other holes below that one are ignored.
  { 75 },  //0000000 D#5
  { 74 },  //0000001 D5
  { 74 },  //0000010 D5
...
const struct kaval_explicit_entry kaval_explicit[128] PROGMEM = {
  //general fingering pattern for each MIDI note. In this case, the index (position from right) of the leftmost uncovered hole is used to determine the MIDI note. This way all other holes below that one are ignored.
...
const struct sackpipa_explicit_entry sackpipa_explicit[64] PROGMEM = {
  //explicit fingering patterns that aren't covered by the general patterns below. Sensor numbers from left to right are L1,L2,L3,R1,R2,R3,R4. The Lthumb, R4 (pinky) and bell sensors are ignored for now.
